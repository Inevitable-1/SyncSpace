...
async function main() {
  ...
  const W = {
    ai: {
      ...
      description: 'Experiments, model training and evaluation for the recommendation engine.',
      color: '#8b5cf6',
      icon: '🧠',
    },
    college: {
      ...
      description:
        'Group coursework for the Distributed Systems semester — final report and ML assignment.',
      color: '#06b6d4',
      icon: '🎓',
    },
    frontend: {
      name: 'Frontend Team',
      description: 'React + Tailwind app building. Design system, components and review cycles.',
      color: '#6366f1',
      icon: '🎨',
    },
    backend: {
      name: 'Backend Team',
      description: 'Node.js APIs, microservices and database design for the platform.',
      color: '#10b981',
      icon: '⚙️',
    },
    marketing: {
      name: 'Marketing',
      description: 'Q3 campaigns, content calendar and growth experiments for the product launch.',
      color: '#f43f5e',
      icon: '📣',
    },
    startup: {
      name: 'Startup Dashboard',
      description: 'Building the investor dashboard MVP — metrics, charts and reporting.',
      color: '#f59e0b',
      icon: '🚀',
    },
    design: {
      name: 'UI Design',
      description: 'Design system, component library and brand guidelines for the product.',
      color: '#ec4899',
      icon: '✨',
    },
  };
  ...
  const memberEmails: Record<string, string[]> = {
    ...
    frontend: [
      'daniel@syncspace.dev',
      'sofia@syncspace.dev',
      'marcus@syncspace.dev',
      'mia@syncspace.dev',
    ],
    backend: [
      'priya@syncspace.dev',
  ...
  const whiteboardCompositions: Record<string, any[]> = {
    ...
    'backend:API Design': [
      ...
      text(
        120,
        330,
        'Rate limiting: 100 req/min per user. All endpoints auth via Bearer JWT.',
        '#1e293b',
        15,
      ),
    ],
...
export async function fetchMetrics() {
  ...
  const chatThreads: Record<
    string,
    { sender: string; content: string; type?: string; minutes?: number; replyTo?: string }[]
  > = {
    'frontend:UI Wireframe': [
      {
      ...
      {
        sender: 'sofia@syncspace.dev',
        content: 'Nice! The spacing on the onboarding step looks much better now.',
        minutes: 130,
      },
      {
        sender: 'daniel@syncspace.dev',
        content: 'I can start building the components tomorrow morning.',
        minutes: 118,
      },
      {
        sender: 'mia@syncspace.dev',
        content: 'Should we also cover the password reset screen in this pass?',
        minutes: 95,
      },
      {
        sender: 'alex@syncspace.demo',
      ...
      {
        sender: 'sofia@syncspace.dev',
        content: 'LGTM, let me add the empty states before we finalize.',
        minutes: 42,
        replyTo: 'mia@syncspace.dev',
      },
      { sender: 'daniel@syncspace.dev', content: '🎉', type: 'emoji', minutes: 30 },
    ],
    'frontend:Design Review': [
      {
        sender: 'marcus@syncspace.dev',
        content: 'Review comments are in — mostly about spacing tokens.',
        minutes: 200,
      },
      {
        sender: 'sofia@syncspace.dev',
        content: 'Thanks Marcus! Updating the scale to a 4px base grid.',
        minutes: 175,
      },
      {
        sender: 'alex@syncspace.demo',
    ...
    'ai:Model Architecture': [
      {
        sender: 'emma@syncspace.dev',
        content: 'Offline eval is at NDCG@10 = 0.68 📈',
        minutes: 260,
      },
      {
        sender: 'alex@syncspace.demo',
      ...
      {
        sender: 'liam@syncspace.dev',
        content: 'Feature freshness — we only update embeddings nightly.',
        minutes: 205,
      },
      {
        sender: 'priya@syncspace.dev',
        content: 'Switching to 4-hour refreshes should close most of the gap.',
        minutes: 180,
      },
      {
        sender: 'emma@syncspace.dev',
        content: 'Planning to kick off the A/B test on 5% traffic Friday.',
        minutes: 60,
      },
    ],
    'backend:API Design': [
      {
        sender: 'liam@syncspace.dev',
        content: 'Auth middleware is up — JWT + refresh rotation done ✅',
        minutes: 320,
      },
      {
        sender: 'alex@syncspace.demo',
      ...
      {
        sender: 'noah@syncspace.dev',
        content: 'Adding Redis-backed limiter later today.',
        minutes: 250,
      },
      {
        sender: 'priya@syncspace.dev',
        content: 'OpenAPI spec is in the repo now, regenerate after changes.',
        minutes: 150,
      },
    ],
    'marketing:Q3 Campaign': [
      {
        sender: 'aisha@syncspace.dev',
        content: 'Teaser drops Tuesday — draft is in the Content Calendar 📅',
        minutes: 180,
      },
      {
        sender: 'emma@syncspace.dev',
        content: 'I pulled the engagement numbers from last quarter as a baseline.',
        minutes: 150,
      },
      {
        sender: 'alex@syncspace.demo',
      ...
      {
        sender: 'aisha@syncspace.dev',
        content: 'On it. Paid plan is approved too. 🚀',
        minutes: 45,
      },
    ],
    'startup:Product Roadmap': [
      {
        sender: 'marcus@syncspace.dev',
        content: 'Moving the investor dashboard MVP to August 15.',
        minutes: 190,
      },
      {
        sender: 'daniel@syncspace.dev',
        content: 'Fine by me — gives us room for the charts polish.',
        minutes: 160,
      },
      {
        sender: 'priya@syncspace.dev',
        content: 'Backend for the metrics endpoint will be ready Friday.',
        minutes: 110,
      },
    ],
    'college:Project Brainstorm': [
      {
        sender: 'daniel@syncspace.dev',
        content: 'Prof approved our distributed consensus topic 🎉',
        minutes: 400,
      },
      {
        sender: 'sofia@syncspace.dev',
        content: 'Great news! Let’s split the report sections this week.',
        minutes: 360,
      },
      {
        sender: 'mia@syncspace.dev',
        content: 'I’ll take the fault-tolerance chapter.',
        minutes: 320,
      },
      {
        sender: 'alex@syncspace.demo',
    ...
    'design:Design System': [
      {
        sender: 'sofia@syncspace.dev',
        content: 'Color palette v2 is up — oklch based, 12 stops per hue.',
        minutes: 210,
      },
      {
        sender: 'alex@syncspace.demo',
      ...
      {
        sender: 'sofia@syncspace.dev',
        content: 'Checked the 12 pairs — all pass, even the lightest gray.',
        minutes: 140,
      },
    ],
  };
  ...
  for (const [roomKey, thread] of Object.entries(chatThreads)) {
    ...
    for (let i = 0; i < thread.length; i++) {
      ...
      await ChatMessage.updateOne(
        { _id: msg._id },
        { $set: { createdAt: minutesAgo(m.minutes ?? i + 1) } },
      );
    }
  }
  ...
  const taskDefs: Record<string, any[]> = {
    frontend: [
      {
        title: 'Build login flow components',
        description: 'Email + password form with validation and Google OAuth button.',
        status: 'completed',
        priority: 'high',
        labels: ['frontend', 'auth'],
        dueIn: -6,
        assignee: 'daniel@syncspace.dev',
        checklist: [
          { text: 'Form validation', done: true },
          { text: 'OAuth button', done: true },
        ],
      },
      {
        title: 'Wire onboarding wizard to API',
        description: 'Connect the three-step onboarding to the /api/onboarding endpoint.',
        status: 'in-progress',
        priority: 'high',
        labels: ['frontend', 'api'],
        dueIn: 2,
        assignee: 'daniel@syncspace.dev',
        checklist: [
          { text: 'API client', done: true },
          { text: 'Error states', done: false },
        ],
      },
      {
        title: 'Fix sidebar collapse on mobile',
        description: 'Hamburger menu should overlay instead of pushing content.',
        status: 'review',
        priority: 'medium',
        labels: ['ui', 'responsive'],
        dueIn: 1,
        assignee: 'mia@syncspace.dev',
      },
      {
        title: 'Add empty states to dashboard cards',
        description: 'Nice illustrations + CTA for empty workspaces and rooms.',
        status: 'todo',
        priority: 'low',
        labels: ['ui', 'polish'],
        dueIn: 4,
        assignee: 'sofia@syncspace.dev',
      },
      {
        title: 'Set up Storybook for component library',
        description: 'Publish the library so designers can browse variants.',
        status: 'todo',
        priority: 'medium',
        labels: ['tooling', 'components'],
        dueIn: 6,
        assignee: 'daniel@syncspace.dev',
      },
    ],
    backend: [
      {
        ...
        description: 'Rotate the refresh token on every use, revoke on reuse.',
        status: 'completed',
        priority: 'urgent',
        labels: ['auth', 'security'],
        dueIn: -3,
        assignee: 'liam@syncspace.dev',
        checklist: [
          { text: 'Rotation logic', done: true },
          { text: 'Reuse detection', done: true },
        ],
      },
      {
        title: 'Add rate limiting to public routes',
        description: '100 req/min per IP on /api/rooms and /api/files.',
        status: 'in-progress',
        priority: 'high',
        labels: ['api', 'security'],
        dueIn: 1,
        assignee: 'noah@syncspace.dev',
      },
      {
        title: 'Write integration tests for meetings API',
        description: 'Cover create, start, join and stats endpoints.',
        status: 'in-progress',
        priority: 'medium',
        labels: ['testing'],
        dueIn: 3,
        assignee: 'priya@syncspace.dev',
      },
      {
        title: 'Optimize member list query',
        description: 'The paginated member query is slow above 500 members.',
        status: 'todo',
        priority: 'medium',
        labels: ['performance'],
        dueIn: 5,
    ...
    ai: [
      {
        title: 'Ship nightly embedding refresh',
        description: 'Move from 24h to 4h refresh for user + item embeddings.',
        status: 'in-progress',
        priority: 'high',
        labels: ['ml', 'pipeline'],
        dueIn: 2,
        assignee: 'priya@syncspace.dev',
        checklist: [
          { text: 'Incremental update', done: true },
          { text: 'Backfill script', done: false },
        ],
      },
      {
        title: 'Run offline eval for ranker v3',
        description: 'Compare NDCG@10 vs v2 on the frozen test set.',
        status: 'review',
        priority: 'high',
        labels: ['ml', 'eval'],
        dueIn: 0,
        assignee: 'emma@syncspace.dev',
      },
      {
        title: 'Launch A/B test on 5% traffic',
        description: 'Randomized split, track engagement and retention for 2 weeks.',
        status: 'todo',
        priority: 'urgent',
        labels: ['experiment'],
        dueIn: 3,
      ...
      {
        title: 'Document candidate generation',
        description: 'Write the design doc for the HNSW index config.',
        status: 'todo',
        priority: 'low',
        labels: ['docs'],
        dueIn: 7,
    ...
    marketing: [
      {
        title: 'Publish teaser for Q3 campaign',
        description: 'TikTok + Instagram Reels teaser, 15s cutdown.',
        status: 'completed',
        priority: 'high',
        labels: ['social'],
        dueIn: -1,
        assignee: 'aisha@syncspace.dev',
      },
      {
        title: 'Draft welcome email series',
        description: '3-email onboarding sequence with product tour.',
        status: 'in-progress',
        priority: 'medium',
        labels: ['email'],
        dueIn: 2,
      ...
      {
        title: 'Set up retargeting audience',
        description: '7-day retargeting for visitors who viewed pricing.',
        status: 'todo',
        priority: 'medium',
        labels: ['ads'],
        dueIn: 4,
    ...
    startup: [
      {
        title: 'Build MRR chart component',
        description: 'Recharts area chart with monthly trend + tooltip.',
        status: 'completed',
        priority: 'high',
        labels: ['dashboard'],
        dueIn: -2,
      ...
      {
        title: 'Expose /api/insights/metrics',
        description: 'Aggregate MRR, active users and churn from events.',
        status: 'in-progress',
        priority: 'high',
        labels: ['backend'],
        dueIn: 1,
      ...
      },
      {
        ...
        description: '10-minute walkthrough for the Friday board call.',
        status: 'todo',
        priority: 'high',
        labels: ['demo'],
        dueIn: 2,
        assignee: 'marcus@syncspace.dev',
      },
    ],
    design: [
      {
        title: 'Finalize color palette v2',
        description: 'oklch based 12-stop scale, all AA compliant.',
        status: 'completed',
        priority: 'high',
      ...
      {
        title: 'Add button size variants',
        description: 'sm / md / lg with icon support.',
        status: 'in-progress',
        priority: 'medium',
        labels: ['components'],
        dueIn: 2,
      ...
      },
      {
        ...
        description: 'Check all component surfaces against AA.',
        status: 'todo',
        priority: 'medium',
        labels: ['a11y'],
        dueIn: 5,
    ...
    college: [
      {
        title: 'Write fault-tolerance chapter',
        description: 'Section 4 — leader election and log replication under failure.',
        status: 'in-progress',
        priority: 'high',
        labels: ['report'],
        dueIn: 5,
      ...
      {
        title: 'Simulate consensus experiments',
        description: 'Raft simulation on 5 nodes with random partitions.',
        status: 'todo',
        priority: 'high',
        labels: ['experiment'],
        dueIn: 7,
      ...
      },
      {
        ...
        description: '10+ sources on distributed consensus algorithms.',
        status: 'completed',
        priority: 'medium',
        labels: ['report'],
        dueIn: -2,
  ...
  const commentDefs: { title: string; by: string; content: string; minutes: number }[] = [
    ...
    {
      title: 'Fix sidebar collapse on mobile',
      by: 'mia@syncspace.dev',
      content: 'Will check the breakpoint and PR by EOD ✅',
      minutes: 150,
    },
    {
      title: 'Add rate limiting to public routes',
      by: 'noah@syncspace.dev',
      content: 'Using the token bucket package, tests included.',
      minutes: 120,
    },
    {
      title: 'Launch A/B test on 5% traffic',
      by: 'emma@syncspace.dev',
      content: 'Variant assignment is deterministic on user_id — no leakage.',
      minutes: 90,
    },
    {
      title: 'Investor demo script',
      by: 'marcus@syncspace.dev',
      content: 'Draft v1 ready, review before Thursday.',
      minutes: 70,
    },
  ];
  for (const c of commentDefs) {
    ...
    await TaskComment.updateOne(
      { _id: comment._id },
      { $set: { createdAt: minutesAgo(c.minutes) } },
    );
  }
  ...
  const fileDefs: FileDef[] = [
    ...
    },
    {
      ...
      size: 18_000,
      folder: '/docs',
      by: 'priya@syncspace.dev',
      minutes: 60 * 70,
    },
    {
      ws: 'ai',
      name: 'training-logs.json',
      mimeType: 'application/json',
      size: 3_100_000,
      folder: '/logs',
      by: 'liam@syncspace.dev',
      minutes: 60 * 12,
    },
    {
      ws: 'ai',
    ...
    {
      ws: 'marketing',
      name: 'q3-campaign.pptx',
      mimeType: 'application/vnd.openxmlformats-officedocument.presentationml.presentation',
      size: 5_600_000,
      folder: '/campaigns',
      by: 'aisha@syncspace.dev',
      minutes: 60 * 28,
    },
    {
      ws: 'marketing',
  ...
  await Invite.create([
    {
      email: 'jordan.reyes@syncspace.dev',
      workspaceId: workspaceDocs.frontend._id,
      invitedBy: alex._id,
      role: 'member',
      status: 'pending',
      expiresAt: inDays(5),
    ...
    {
      email: 'yuki.tanaka@syncspace.dev',
      workspaceId: workspaceDocs.ai._id,
      invitedBy: alex._id,
      role: 'member',
      status: 'pending',
      expiresAt: inDays(4),
    ...
    {
      email: 'maria.fernandez@syncspace.dev',
      workspaceId: workspaceDocs.startup._id,
      invitedBy: alex._id,
      role: 'admin',
      status: 'pending',
      expiresAt: inDays(6),
  ...
  const activityDefs: {
    ...
    },
    {
      action: 'sent invite',
      entityType: 'invite',
      entityName: 'jordan.reyes@syncspace.dev',
      minutes: 60 * 24 * 4,
      by: DEMO_EMAIL,
    },
    {
    ...
    },
    {
      action: 'created task',
      entityType: 'task',
      entityName: 'Wire onboarding wizard to API',
      minutes: 60 * 24 * 2,
      by: DEMO_EMAIL,
    },
    {
      ...
      entityType: 'task',
      entityName: 'Build login flow components',
      minutes: 60 * 24 * 1,
      by: DEMO_EMAIL,
    },
    {
    ...
    },
    {
      action: 'created task',
      entityType: 'task',
      entityName: 'Simulate consensus experiments',
      minutes: 60,
      by: DEMO_EMAIL,
    },
  ];
  ...
  const notificationDefs: {
  ...
  }[] = [
    {
      ...
      message: 'Q3 Campaign Sync is live now — 4 participants joined.',
      type: 'success',
      entityType: 'room',
      minutes: 55,
      isRead: false,
    },
    {
      ...
      message: 'You created AI Research Lab.',
      type: 'success',
      entityType: 'workspace',
      minutes: 60 * 24 * 40,
      isRead: true,
    ...
    {
      title: 'File Uploaded',
      message: 'Emma Wilson uploaded dataset.csv to AI Research Lab.',
      type: 'info',
      entityType: 'workspace',
      minutes: 60 * 40,
      isRead: false,
    ...
    {
      title: 'Member Joined',
      message: 'Sofia Rodriguez joined Frontend Team.',
      type: 'success',
      entityType: 'member',
      minutes: 60 * 24 * 6,
      isRead: true,
    },
    {
      ...
      message: 'Marcus Lee accepted your invite to Startup Dashboard.',
      type: 'success',
      entityType: 'invite',
      minutes: 60 * 24 * 2,
      isRead: false,
    ...
    {
      title: 'Room Created',
      message: 'You created "Model Architecture" in AI Research Lab.',
      type: 'info',
      entityType: 'room',
      minutes: 60 * 24 * 8,
      isRead: true,
    },
    {
      ...
      message: 'Daniel Chen completed "Build login flow components".',
      type: 'info',
      entityType: 'activity',
      minutes: 60 * 24,
      isRead: false,
    },
    {
      ...
      message: 'Investor Demo Rehearsal is scheduled for Friday.',
      type: 'info',
      entityType: 'room',
      minutes: 60 * 5,
      isRead: false,
    ...
    {
      title: 'New Comment',
      message: 'Noah Garcia commented on "Add rate limiting to public routes".',
      type: 'info',
      entityType: 'activity',
      minutes: 120,
      isRead: true,
  ...
  for (const n of notificationDefs) {
    ...
    await Notification.updateOne(
      { _id: notif._id },
      { $set: { createdAt: minutesAgo(n.minutes) } },
    );
  }
  ...
  if (activeRoom) {
    await RoomPresence.create([
      ...
      {
        room: activeRoom._id,
        user: usersByEmail['aisha@syncspace.dev']._id,
        status: 'online',
        socketId: 'seed-socket-aisha',
      },
      {
        room: activeRoom._id,
        user: usersByEmail['emma@syncspace.dev']._id,
        status: 'online',
        socketId: 'seed-socket-emma',
      },
    ]);
  }
